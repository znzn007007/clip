...
describe('BatchRunner', () => {
  ...
  describe('processUrl', () => {
    ...
    it('throws ClipError on invalid URL', async () => {
      ...
      await expect(
        runner['processUrl']('not-a-url', mockContext, options)
    ...
    it('skips asset downloads when disabled', async () => {
      ...
      await runner['processUrl']('https://x.com/status/123', mockContext, options);
    ...
    it('returns failed ExportResult for ClipError', async () => {
      ...
      const result = await runner['processUrl']('https://x.com/status/123', mockContext, options);
    ...
    it('rethrows non-ClipError exceptions', async () => {
      ...
      await expect(
        runner['processUrl']('https://x.com/status/123', mockContext, options)
